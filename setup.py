...
all_modules = {
        ...
        'daal.algorithms.decision_tree.classification': '_classification_',
        'daal.algorithms.decision_tree.classification.prediction': '_prediction4_',
        'daal.algorithms.decision_tree.classification.training': '_training4_',
        'daal.algorithms.decision_tree.regression': '_regression_',
        'daal.algorithms.decision_tree.regression.prediction': '_prediction5_',
        'daal.algorithms.decision_tree.regression.training': '_training5_',
        ...
        'daal.algorithms.gbt.classification': '_classification1_',
        'daal.algorithms.gbt.classification.prediction': '_prediction6_',
        'daal.algorithms.gbt.classification.training': '_training6_',
        'daal.algorithms.gbt.regression': '_regression1_',
        'daal.algorithms.gbt.regression.prediction': '_prediction7_',
        'daal.algorithms.gbt.regression.training': '_training7_',
        'daal.algorithms.gbt.training': '_training8_',
        'daal.algorithms.implicit_als': '_implicit_als_',
        'daal.algorithms.implicit_als.prediction.ratings': '_ratings_',
        'daal.algorithms.implicit_als.training': '_training9_',
        ...
        'daal.algorithms.linear_model.prediction': '_prediction8_',
        'daal.algorithms.linear_model.training': '_training10_',
        'daal.algorithms.linear_regression': '_linear_regression_',
        'daal.algorithms.linear_regression.prediction': '_prediction9_',
        ...
        'daal.algorithms.linear_regression.training': '_training11_',
        'daal.algorithms.logistic_regression': '_logistic_regression_',
        'daal.algorithms.logistic_regression.prediction': '_prediction10_',
        'daal.algorithms.logistic_regression.training': '_training12_',
        'daal.algorithms.logitboost': '_logitboost_',
        'daal.algorithms.logitboost.prediction': '_prediction11_',
        'daal.algorithms.logitboost.quality_metric_set': '_quality_metric_set3_',
        'daal.algorithms.logitboost.training': '_training13_',
        ...
        'daal.algorithms.multi_class_classifier.prediction': '_prediction12_',
        'daal.algorithms.multi_class_classifier.quality_metric_set': '_quality_metric_set4_',
        'daal.algorithms.multi_class_classifier.training': '_training14_',
        'daal.algorithms.multinomial_naive_bayes': '_multinomial_naive_bayes_',
        'daal.algorithms.multinomial_naive_bayes.prediction': '_prediction13_',
        'daal.algorithms.multinomial_naive_bayes.quality_metric_set': '_quality_metric_set5_',
        'daal.algorithms.multinomial_naive_bayes.training': '_training15_',
        ...
        'daal.algorithms.neural_networks.prediction': '_prediction14_',
        'daal.algorithms.neural_networks.training': '_training16_',
        ...
        'daal.algorithms.regression': '_regression2_',
        'daal.algorithms.regression.prediction': '_prediction15_',
        'daal.algorithms.regression.training': '_training17_',
        'daal.algorithms.ridge_regression': '_ridge_regression_',
        'daal.algorithms.ridge_regression.prediction': '_prediction16_',
        'daal.algorithms.ridge_regression.training': '_training18_',
        'daal.algorithms.sorting': '_sorting_',
        'daal.algorithms.stump': '_stump_',
        'daal.algorithms.stump.prediction': '_prediction17_',
        'daal.algorithms.stump.training': '_training19_',
        'daal.algorithms.svd': '_svd_',
        'daal.algorithms.svm': '_svm_',
        'daal.algorithms.svm.prediction': '_prediction18_',
        'daal.algorithms.svm.quality_metric_set': '_quality_metric_set8_',
        'daal.algorithms.svm.training': '_training20_',
        'daal.algorithms.univariate_outlier_detection': '_univariate_outlier_detection_',
        'daal.algorithms.weak_learner': '_weak_learner_',
        'daal.algorithms.weak_learner.prediction': '_prediction19_',
        'daal.algorithms.weak_learner.training': '_training21_',
        'daal.daal': '_daal_',
